  ...
  <div class="goods_list">
    ...
    <div class="goods_list_box banxin">
      ...
      <div class="goods_list_content">
        <!-- 品牌导航部分 -->
        <div class="brand_nav">
          <p class="brand_title">品牌</p>
          <ul class="brand_all">
            <li :class="brandFlag == item.check_id?'brand_box active':'brand_box'" @click="choiceBrand(item.check_id)" v-for="(item, index) in brandName" :key="index">{{item.name}}</li>
          </ul>
