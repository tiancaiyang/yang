    ...
    <div class="evaluate_content">
      ...
      <div class="evaluate_content_top">
        ...
        <div class="goods_show">
          ...
          <p class="goods_title">德经典小甘菊护手</p>
          <p>颜色分类：绿色</p>
          <p>尺码：4.8g</p>
        </div>
        <!-- 评价内容区 -->
      ...
      <div class="evaluate_point">
        ...
        <div class="point_star">
          <p>
            <span>描述相符</span>
            <el-rate v-model="value1" :colors="['#999999', '#008286', '#008286']"></el-rate>
            <span class="star_num">{{value1 + '.00'}}</span>
          </p>
          <p>
            <span>物流态度</span>
            <el-rate v-model="value2" :colors="['#999999', '#008286', '#008286']"></el-rate>
            <span class="star_num">{{value2 + '.00'}}</span>
          </p>
          <p>
            <span>服务态度</span>
            <el-rate v-model="value3" :colors="['#999999', '#008286', '#008286']"></el-rate>
