          ...
          <div class="boxLeft fl">
            <div v-show="num == '1'" class="contentBox">
              ...
              <div class="leftLIst return">
                ...
                <el-input size="small" v-model="inputPrice" @change="decidePrice">
                </el-input>
                <p class="returnPrice">最多退金额￥{{ input1 }}，不包含邮费</p>
              </div>
              <div class="leftLIst">
                <span class="leftTS"><b>*</b> 退款说明:</span>
                <el-input type="textarea" maxlength="200" resize="none" :autosize="{ minRows: 4, maxRows: 4}"
            ...
            <div v-show="num == '3'" class="four">
              <div class="accountInfo">
                <div class="accountInfoTop">
                  ...
                  <p>退款成功时间：{{this.refundData.create_time}} </p>
                  <p>退回总金额：<span>￥{{this.refundData.refund_amount}}</span></p>
          ...
          <div class="boxRight fr">
            ...
            <div class="goodsTel">
              <div class="goodsTel">
                ...
                <p>单&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价：<span>￥{{ productData.price }}*{{ productData.num
                    }}（数量）</span></p>
      ...
      getOrderRefundDetail(total) {
          ...
          refundOrderDetail(params).then(res => {
            ...
            if (res.code == 0) {
              ...
              if (this.refundStatus == 0 || this.refundStatus == 2 || this.refundStatus == 3 || this.refundStatus ==
                5 || this.refundStatus == 6) {
                this.num = 2
